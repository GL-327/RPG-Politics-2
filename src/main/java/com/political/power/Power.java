...
public enum Power {
    ...
    ICARUS_DIVE("Icarus Dive", Origin.COMPOUND_V, 35, 160,
            "Take to the skies under Viltrumite flight, then hurl yourself forward like a missile."),
    HEAT_VISION_OVERLOAD("Heat Vision Overload", Origin.COMPOUND_V, 48, 110,
            "Pour everything into your eyes \u2014 a roaring beam that scorches and detonates."),
    GROUND_POUND("Ground Pound", Origin.COMPOUND_V, 32, 120,
            "Slam down with Viltrumite force, cratering the ground and flinging foes away."),
    SHOCK_PULSE("Shock Pulse", Origin.COMPOUND_V, 28, 90,
            "Discharge an electric pulse that arcs to your target and jolts everything near."),
    TITAN_GRIP("Titan Grip", Origin.COMPOUND_V, 35, 100,
            "Seize a foe in a crushing grip and slam them down."),
    AFTERIMAGE("Afterimage", Origin.COMPOUND_V, 26, 140,
            "Move so fast you leave afterimages \u2014 blinding speed and a flicker of invisibility."),
    REGEN_SURGE("Regen Surge", Origin.COMPOUND_V, 34, 200,
            "Force your cells into overdrive, purging toxins and mending wounds."),
    WIND_BLAST("Wind Blast", Origin.COMPOUND_V, 24, 80,
            "Clap the air into a concussive blast that hurls everything ahead away."),
    METEOR_DROP("Meteor Drop", Origin.COMPOUND_V, 50, 180,
            "Call down your full mass on a point, detonating it like an impact crater."),
    SEISMIC_SLAM("Seismic Slam", Origin.COMPOUND_V, 30, 120,
            "Rupture the earth beneath your foes, throwing them skyward."),
    ...
    MAXIMUM_METEOR("Maximum: Meteor", Origin.CURSED_TECHNIQUE, 95, 420,
            "Hurl a condensed mass of cursed flame that lands like a falling star."),
    FIRE_ARROW_FUGA("Fire Arrow: Fuga", Origin.CURSED_TECHNIQUE, 42, 120,
            "Launch a lancing arrow of cursed fire that burns through everything in line."),
    COFFIN_IRON_MOUNTAIN("Coffin of the Iron Mountain", Origin.CURSED_TECHNIQUE, 60, 260,
            "Sink into a crushing aquatic domain \u2014 hardened, untouchable, drowning all who close in."),
    SELF_EMBODIMENT("Self-Embodiment of Perfection", Origin.CURSED_TECHNIQUE, 100, 600,
            "Unfurl your domain of idle transfiguration: every soul within is reshaped and unmade."),
    SOUL_TRANSFIGURATION("Soul Transfiguration", Origin.CURSED_TECHNIQUE, 45, 160,
            "Touch a foe's soul and twist its shape, crippling body and mind."),
    CHIMERA_SHADOW_GARDEN("Chimera Shadow Garden", Origin.CURSED_TECHNIQUE, 90, 500,
            "Flood the field with living shadow, loosing a pack of shikigami at your command."),
    NUE_STRIKE("Nue", Origin.CURSED_TECHNIQUE, 35, 130,
            "Send the thunderbird Nue diving down in a crash of lightning on your mark."),
    GRAVITY_WELL("Gravity Well", Origin.CURSED_TECHNIQUE, 70, 300,
            "Collapse cursed gravity to a single point, dragging in and crushing all nearby."),
    MALEVOLENT_SHRINE("Malevolent Shrine", Origin.CURSED_TECHNIQUE, 110, 700,
            "Manifest the open shrine: relentless cleaving and dismantling rends everything around you.");
